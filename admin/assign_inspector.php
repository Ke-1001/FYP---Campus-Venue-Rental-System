    ...
    <main class="flex-1 flex flex-col h-screen overflow-hidden relative bg-slate-50">
        ...
        <div class="flex-1 overflow-y-auto p-8 scroll-smooth">
            ...
            <div class="mb-6">
                ...
                <p class="text-xs text-slate-500 mt-1">Filter multidimensional data to delegate post-event venue inspections to authorized personnel.</p>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                <div class="px-6 py-4 border-b border-slate-100 bg-slate-50 flex justify-between items-center">
                    <h3 class="text-[11px] font-black text-slate-500 uppercase tracking-widest">Delegation Queue (<?php echo $result->num_rows; ?>)</h3>
                    <span class="text-[10px] text-slate-400 font-bold uppercase tracking-widest"><i data-lucide="user-plus" class="w-3 h-3 inline pb-0.5"></i> Pending Assignment</span>
                </div>
                <table class="w-full text-left border-collapse">
                    <thead class="bg-white text-[10px] text-slate-400 font-black uppercase tracking-widest border-b border-slate-100">
                        <tr>
                            ...
                            <th class="px-6 py-3">Delegation State</th>
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="5" class="px-6 py-12 text-center text-slate-500 font-medium">
                                    ...
                                    Query returned zero vectors. No pending assignments match criteria.
                                </td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
