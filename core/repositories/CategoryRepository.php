...
class CategoryRepository {
    ...
    public function deleteCategories(array $vcids): bool {
        ...
        if ($row && $row['dependency_count'] > 0) {
            // 拋出明確的異常，阻斷刪除程序
            throw new \Exception("Constraint Violation: One or more selected categories are currently tied to existing venues. Please reassign those venues before purging.");
        }
