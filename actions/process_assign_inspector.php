    ...
    try
    {
        ...
        if ($sid_raw === 'RA01')
        {
            $sql_ra01 = "
                ...
                LEFT JOIN (SELECT i.sid, COUNT(*) as clash_count FROM inspection i
                    JOIN booking b ON i.bid = b.bid WHERE b.date_booked = ? AND b.time_end = ? AND i.ins_status = 'pending'
                    GROUP BY i.sid) clash ON s.sid = clash.sid
