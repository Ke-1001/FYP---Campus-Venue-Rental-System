<?php
// This section checks and updates admin personal details.
session_start();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST')
{
    if ($action === 'update_profile')
    {
        ...
        $stmt_check->bind_param("si", $email, $aid);
        $stmt_check->execute();
    ...
    elseif ($action === 'update_password')
    {
        ...
        if ($stmt_update)
        {
            $stmt_update->bind_param("si", $new_hash, $aid);
