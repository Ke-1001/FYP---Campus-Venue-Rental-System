<div class="navbar flex items-center justify-between px-8 py-4 bg-slate-900/50 backdrop-blur-md border-b border-white/10">
    <div class="nav-brand flex items-center gap-3">
        <a href="/FYP/User/user_dashboard.php" class="flex items-center gap-3 group">
            <div class="bg-blue-600 p-2 rounded-xl shadow-[0_0_15px_rgba(37,99,235,0.4)] group-hover:scale-110 transition-transform">
                <span class="text-white font-black text-xl">C</span>
            </div>
            <span class="text-2xl font-black text-white tracking-tighter hover:text-blue-400 transition-colors">CVBMS</span>
        </a>
    </div>
